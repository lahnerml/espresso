...
class TestLBGetUAtPos(ut.TestCase):
    ...
    def setUpClass(self):
        ...
        self.system.cell_system.skin = 0.0004
    ...
    def test_get_u_at_pos(self):
        ...
        r = []
        for n in range(self.n_nodes_per_dim):
            va = self.lb_fluid.get_interpolated_velocity(
                    self.system.part[n].pos)
            r.append(va)

        numpy.testing.assert_allclose(self.interpolated_vels[:-1], r[:-1],
                                      atol=1e-4)
