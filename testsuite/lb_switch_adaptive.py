...
@ut.skipIf(espressomd.has_features(["LB_ADAPTIVE"]),
...
class LBSwitchActor(ut.TestCase):
    ...
    def switch_test(self, GPU=False):
        ...
        lb_fluid_1_params = {'agrid': 1.0, 'dens': 1.0, 'visc': 1.0, 'fric': gamma_1, 'tau': 0.03}
        lb_fluid_2_params = {'agrid': 1.0, 'dens': 1.0, 'visc': 1.0, 'fric': gamma_2, 'tau': 0.03}
        ...
        for p in product(range(8), range(8), range(8)):
